...
class bybit(ccxt.async_support.bybit):
    ...
    async def watch_tickers(self, symbols: Strings = None, params={}):
        ...
        ticker = await self.watch_topics(url, messageHash, topics, messageHash, params)
        if self.newUpdates:
            return ticker
    ...
    async def watch_ohlcv_for_symbols(self, symbolsAndTimeframes: List[List[str]], since: Int = None, limit: Int = None, params={}):
        ...
        symbol, timeframe, stored = await self.watch_topics(url, messageHash, topics, messageHash, params)
        if self.newUpdates:
    ...
    def parse_ws_ohlcv(self, ohlcv, market=None) -> list:
        ...
        return [
            ...
            self.safe_integer(ohlcv, 'confirm'),
        ]
    ...
    async def watch_trades_for_symbols(self, symbols: List[str], since: Int = None, limit: Int = None, params={}):
        ...
        trades = await self.watch_topics(url, messageHash, topics, messageHash, params)
        if self.newUpdates:
