...
import { MarketChartComponentProps } from '@/app/market/components/chart/marketChartComponent';

interface MarketChartContainerProps extends MarketChartComponentProps {
  container: any;
}

export const MarketChartContainer = forwardRef((props: MarketChartContainerProps, ref) => {
  const {
    container,
    options,
...
MarketChartContainer.displayName = 'ChartContainer';
