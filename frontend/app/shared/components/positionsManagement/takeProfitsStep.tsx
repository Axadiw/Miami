          ...
          <Group>
            ...
            <Text c="green">
              {calculatedValues &&
                tp1 &&
                tp1Percent &&
                `${displayUpToPrefixes ? 'up to ' : ''} $ ${calculatedValues.tp1USDReward.toFixed(
                  2
                )}`}
            </Text>
          </Group>
          ...
          <Group>
            ...
            <Text c="green">
              {calculatedValues &&
                tp2 &&
                tp2Percent &&
                `${displayUpToPrefixes ? 'up to ' : ''} $ ${calculatedValues.tp2USDReward.toFixed(
                  2
                )}`}
            </Text>
          </Group>
        ...
        <Group>
          ...
          <Text c="green">
            {calculatedValues &&
              tp3 &&
              tp3Percent &&
              `${displayUpToPrefixes ? 'up to ' : ''} $ ${calculatedValues.tp3USDReward.toFixed(
                2
              )}`}
          </Text>
        </Group>
