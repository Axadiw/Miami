...
import { SetScaledRange } from '@/app/scaled/components/setScaledRange/setScaledRange';
import { ScaledChart } from './components/chart/scaledChart';
...
export default function ScaledPage() {
  ...
  const { mutateAsync, isPending, reset, error: createError } = dataLayer.useCreateScaledPosition();
    ...
    <SimpleGrid cols={{ base: 1, sm: 2 }}>
      ...
      <Stack>
        <Stack>
          {selectedSymbol && (
            <>
              <ScaledChart calculatedValues={calculatedValues} />
              <TimeframesSelector />
            </>
          )}
          <ExternalChartHelper />
