...
import { ScaledChartComponentProps } from '@/app/scaled/components/chart/scaledChartComponent';

interface ScaledChartContainerProps extends ScaledChartComponentProps {
  container: any;
}

export const ScaledChartContainer = forwardRef((props: ScaledChartContainerProps, ref) => {
  const {
    container,
    options,
    ...
    updateUpperAfterDragging,
    updateLowerAfterDragging,
  } = props;
        ...
        chart.subscribeCustomPriceLineDragged((params) => {
          switch (params.customPriceLine.options().title) {
            ...
            case 'TP3': // TODO: move to const
              ...
              break;
            case 'Upper': // TODO: move to const
              updateUpperAfterDragging(params.customPriceLine.options().price);
              break;
            case 'Lower': // TODO: move to const
              updateLowerAfterDragging(params.customPriceLine.options().price);
              break;
          }
        });
...
ScaledChartContainer.displayName = 'ScaledChartContainer';
